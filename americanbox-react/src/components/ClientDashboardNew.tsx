  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <StatsCard title="Total Pedidos" value={stats.totalOrders} icon={<Package />} color="blue" />
        <StatsCard title="En Proceso" value={stats.prealerta + stats.captado + stats.viajando + stats.aduana} icon={<Clock />} color="yellow" />
        <StatsCard title="Entregados" value={stats.entregado} icon={<CheckCircle />} color="green" />
        <StatsCard title="Total Gastado" value={`$${stats.totalAmount.toFixed(2)}`} icon={<CreditCard />} color="purple" />
      </div>
              ...
              <div>
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">${trackingResult.total.toFixed(2)}</span>
                  </div>
                  <div className="flex justify-between">
