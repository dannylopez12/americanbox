      ...
      <div className="rounded-2xl bg-white border border-slate-200 overflow-hidden">
        ...
        <div className="border-t border-slate-200 overflow-x-auto">
          <table className="w-full text-sm">
            ...
            <tbody>
              {loading && (
                <tr className="border-t"><Td colSpan={8}><div className="py-8 text-center text-slate-500">Cargando...</div></Td></tr>
              )}
              {!loading && items.length === 0 && (
                <tr className="border-t"><Td colSpan={8}><div className="py-8 text-center text-slate-500">Sin datos.</div></Td></tr>
              )}
              ...
              {items.map(c=>(
                <tr key={c.id} className="border-t hover:bg-slate-50">
                  ...
                  <Td className="whitespace-nowrap">${c.price_per_lb ? c.price_per_lb.toFixed(2) : "-"}</Td>
                  <Td>
            ...
            <div className="grid md:grid-cols-2 gap-3">
              ...
              <Field label="Precio por libra (USD)">
                <input 
                  ...
                  onChange={e=>setForm({...form, price_per_lb: e.target.value ? parseFloat(e.target.value) : null})} 
                  placeholder="Ej: 4.85"
                />
              </Field>
